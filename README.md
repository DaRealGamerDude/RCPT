...
🏗️ Architecture
Frontend (React) ↓ Backend (Node.js + Express) ↓ Blockchain API (Etherscan)

⚙️ How It Works
User inputs a wallet address

Backend fetches transaction data via Etherscan API

Data is processed into:

Wallet statistics
Graph structure (nodes + edges)
Detection logic flags suspicious patterns
...
⚠️ Disclaimer
This project is for educational and demonstration purposes only. It simulates blockchain forensic workflows and does not guarantee real-world investigative accuracy.
